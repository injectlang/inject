...
func newNonInterpolatedCmdStr(src []byte, filename string) *nonInterpolatedCmdStr {
	// TODO: prob shouldn't be parsing in the new() func
	// maybe have this instead:
	//   func Parse(src, filename) (*nonInterpolatedCmdStr, hcl.Diagnostics) {}
...
func (ni *nonInterpolatedCmdStr) Diags() hcl.Diagnostics {
	return ni.diags
}
...
// tokens are removed, offset will be set to +1, -1, etc. so that
// line numbers will be correct in diagnostic output.
//
